...
Route::post('/sample-orders/cancel/{id}', [HomeController::class, 'cancelOrder'])->name('sample_orders.cancel');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('/custom-order', 'custom_store')->name('products.custom-store');
    // Route::post('/sample-order-store', 'sample_order_store')->name('sample_order.store');
    Route::post('/sample-order-store', 'sample_order_store')->name('sample_order.store');
    Route::get('/sample-orders', 'sampleOrders')->name('sample-orders.index');
    Route::get('/sample-orders/{id}', 'viewSampleOrder')->name('sample_orders.view');
    // Route::post('/sample-orders/cancel/{id}',  'cancelOrder')->name('sample_orders.cancel');
    ...
    Route::get('/gemstones', 'all_brands')->name('brands.all');
	Route::get('/birthstones', 'all_birthstones')->name('birthstones.all');
	Route::get('/birthstone/{slug}', 'birthstone_gemstones')->name('birthstones.gemstone_month');
...
Route::controller(SearchController::class)->group(function () {
    ...
    Route::get('/gemstone/{brand_slug}', 'listingByBrand')->name('products.gemstone');
});
...
Route::controller(PageController::class)->group(function () {
    ...
    Route::get('/pages/customize-product', 'customize_product')->name('pages.customize-product');
    Route::get('/pages/our-process', 'our_process')->name('pages.our-process');
});
