...
Route::controller(PosController::class)->group(function () {
	...
	Route::get('pos/autosearch', 'autosearch')->name('pos.autosearch');
...
Route::post('/pos/update-session-user-cart', [PosController::class, 'updateSessionUserCartData'])->name('pos.updateSessionUserCartData');
