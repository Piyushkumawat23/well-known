...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/products/admin/{id}/barcode','admin_product_barcode')->name('products.admin.barcode');
        // Route::get('/admin/product/barcode/download/{sku}', 'downloadBarcode')
        //             ->where('sku', '.*')
        //             ->name('admin.product.barcode.download');

                    Route::get('/product/barcode/download/png/{sku}', 'pngdownloadBarcode')
                    ->where('sku', '.*')
                    ->name('product.barcode.download.png');
        ...
        // New route for updating SKUs for all products
        Route::get('/products/update-sku/all', 'updateAllSkuCombinations')->name('admin.updateAllSku');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::get('/customers/information/{id}', 'customers_info')->name('customers.information');
        Route::post('/users/update-salesperson', 'update_salesperson')->name('users.update-salesperson');
        Route::post('/users/add-salesperson','add_salesperson')->name('users.add-salesperson');



          //Product Bulk Upload

          Route::get('/users-bulk-upload/index', 'bulkindex')->name('users_bulk_upload.bulk');

          Route::post('/bulk-users-upload', 'bulk_users_upload')->name('bulk_users_upload');
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        Route::post('/business-settings/wholesale_update', 'wholesale_update')->name('business_settings.wholesale_update');
        ...
        Route::get('/wholesale-index', 'wholesale_index')->name('wholesale.index');
        ...
        // Admin routes
        Route::resource('process_steps', ProcessStepController::class);
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/orders/store', 'adminstore')->name('orders.store');
        Route::get('/product-search', 'search')->name('products.search');

        Route::get('/all_orders/{id}/show', 'all_orders_show')->name('all_orders.show');


        Route::post('/addresses/store','adminstoreAddress')->name('admin.addresses.store');
        
        // Custom Orders
        Route::get('/custom_orders', 'custom_orders')->name('custom_orders.index');
        Route::get('/custom_orders/{id}/show', 'custom_orders_show')->name('custom_orders.show');
    ...
    Route::post('/update-order-status', [SampleController::class, 'updateOrderStatus'])->name('update-order-status');

    Route::resource('sample_orders', SampleController::class);
    Route::controller(SampleController::class)->group(function () {
      

        Route::get('/sample_orders', 'sample_orders')->name('sample_orders.index');
        Route::get('/sample_orders/{id}/show', 'sample_orders_show')->name('sample_orders.show');

        Route::post('/bulk-sample-order-delete', 'bulk_sample_order_delete')->name('bulk-sample-order-delete');
