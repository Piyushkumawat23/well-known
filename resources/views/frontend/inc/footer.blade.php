        ...
        <div class="row no-gutters">
            ...
            <!-- <div class="col-lg-3 col-md-6">
                <a class="text-reset border-left text-center p-4 d-block" href="{{ route('supportpolicy') }}">
                    <i class="la la-support la-3x text-footer-white mb-2"></i>
            ...
            <div class="subscribe">
               <div class="row align-items-center">
                  <div class="col-lg-6 col-md-6">
                     <div class="subscribe-text"><span class="title">
                  ...
                  <div class="col-lg-6 col-md-6">
					 ...
					 <div class="d-inline-block d-md-block mb-4">
                        <form class="form-inline newsletter-form" method="POST" action="{{ route('subscribers.store') }}">
                            @csrf
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-xl-4 text-center text-md-left">
                <div class="mt-4">
				<!--<h4 class="fs-18 text-uppercase fw-600  pb-2 mb-4">About {{ get_setting('site_name') }}</h4> -->
                    <a href="{{ route('home') }}" class="d-block">
                        @if(get_setting('footer_logo') != null)
                            <img class="lazyload mw-100 h-30px h-md-70px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="70" style="height: 120px;">
                        @else
                            <img class="lazyload mw-100 h-30px h-md-70px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="70" style="height: 120px;">
                        @endif
                    </a>
                    <!-- <div class="my-3">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-18 text-uppercase fw-600  pb-2 mb-2">
            ...
            <div class="col-md-3 col-lg-2">
                ...
                @if (get_setting('vendor_system_activation') == 1)
                    <div class="text-center text-md-left mt-4 display-none">
			 ...
			 <div class="col-lg-3 ml-xl-auto col-md-4 mr-0 contact-info-box">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-18 text-uppercase fw-600  pb-2 mb-2">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                          ...
                          <!--  <span class="d-block opacity-70"><i class="las la-map-marker-alt"></i> {{ get_setting('contact_address',null,App::getLocale()) }}</span> -->
                           <span class="d-block opacity-70"><i class="las la-map-marker-alt"></i> USA</span>
                        </li>
                        <li class="mb-2">
                           <!--<span class="d-block opacity-30">{{translate('Phone')}}:</span> -->
                           <span class="d-block opacity-70"><i class="las la-phone"></i> {{ get_setting('contact_phone') }}</span>
                        </li>
                        <li class="mb-4">
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 bg-black text-light footer_area_2">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4">
