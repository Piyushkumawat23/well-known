            ...
            <div class="d-flex align-items-center">
				<div class="col-auto col-xl-4 pl-0 pr-3  pt-3  d-flex align-items-center  mobile-display-not">
					<div class="home_contact">
						<div class="contact_box contact_box_address float-left">
							<label class="custom-display">Location</label>
                ...
                <div class="col-auto col-xl-4 pl-4 pr-3 d-flex align-items-center">
                    <a class="d-block py-10px mr-3 ml-0 " href="{{ route('home') }}">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-70px logo-mid" height="40" style="height: 100px;">
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-100px" height="40" style="height: 100px;">
                        @endif
                    </a>
    ...
    <ul class="exo-menu">
      ...
      <li class="mega-drop-down"><a href="javascript:void(0)"><i class="fa fa-list"></i> Shop </a>
		...
		<?php 
            ...
            // Group gemstones into rows of 12 for consistent design
            ...
            <?php
                    // Only show the title for the first section
                    $title_gemstone = " ";
                }
            }
            ?>
