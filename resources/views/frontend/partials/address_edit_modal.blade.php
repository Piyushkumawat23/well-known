<form class="form-default" role="form" action="{{ route('addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
        ...
        @if (get_setting('google_map') == 1)
            <div class="row">
                ...
                <ul id="geoData">
                    ...
                    <li style="display: none;">Zip Code: <span id="postal_code"></span></li>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ translate('Your Zip Code')}}" value="{{ $address_data->postal_code }}" name="postal_code" value="" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ translate('')}}" value="{{ $address_data->phone }}" name="phone" value="" required>
            </div>
        </div>
