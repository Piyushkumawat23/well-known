...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
        ...
        <div class="card-body">
            <p class="float-right" style="color: rgb(23 23 21);"><span class="btn btn-icon btn-circle btn-light" style="background-color: rgb(247 242 192);"></span> Salesperson Order</p>
