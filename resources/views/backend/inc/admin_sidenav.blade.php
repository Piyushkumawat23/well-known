            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('custom_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['custom_orders.index', 'custom_orders.show'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Customize Orders')}}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('sample_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sample_orders.index', 'sample_orders.show'])}}">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item ">
                                <a href="{{ route('users_bulk_upload.bulk') }}" class="aiz-side-nav-link" >
                                    <span class="aiz-side-nav-text">{{ translate('User Bulk Import') }}</span>
                                </a>
                            </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('process_steps.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Our Process')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
