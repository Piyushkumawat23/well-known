            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="canonical_tag" value="{{ $category->canonical_tag }}" placeholder="{{translate('Canonical Tag')}}">
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6">{{translate('SEO Content')}}</h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    name="seo_content">{{ $category->seo_content }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
