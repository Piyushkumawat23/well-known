						 ...
						 <div class="form-group row" id="brand">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="brand_id" id="brand_id" data-live-search="true">
                                    ...
                                    <option value="{{ $brand->id }}" @if($product->brand_id == $brand->id) selected @endif>{{ $brand->getTranslation('name') }} {{ !empty($brand->gemstone_month) ? ' - '. $brand->gemstone_month : ''; }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="video" data-multiple="false">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" type="file" id="videos" name="videos" value="{{$product->videos}}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control aiz-selectpicker attribute_choice" data-live-search="true" name="choice_options_{{ $choice_option->attribute_id }}[]" multiple>
                                        @foreach (\App\Models\AttributeValue::where('attribute_id', $choice_option->attribute_id)->orderByRaw('value+0 asc')->get() as $row)
...
<!--                <div class="card">
			...
			<div class="card">
                    <div class="card-header">
					  <button type="submit" name="button" class="btn btn-info" style="width: 320px;">{{ translate('Update Product') }}</button>
