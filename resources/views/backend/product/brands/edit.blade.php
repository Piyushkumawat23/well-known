        ...
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group row" id="">
					<label class="col-sm-3 col-from-label" for="name">{{translate('Gemstone Month')}}</label>
					<div class="col-sm-9">
					<select class="form-control aiz-selectpicker" name="gemstone_month" id="gemstone_month" data-selected="{{ $brand->gemstone_month }}"  data-live-search="true">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Canonical Tag')}}</label>
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="canonical_tag" value="{{ $brand->canonical_tag }}" placeholder="{{translate('Canonical Tag')}}">
                    </div>
                </div>
                <div class="form-group row">
