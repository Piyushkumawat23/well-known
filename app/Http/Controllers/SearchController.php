...
class SearchController extends Controller
{
    ...
    // {
    //     // Filtering options
    //     $category_id = $request->input('category_id'); // Fix parameter mismatch
    ...
    //     $products = filter_products($products)->with('taxes')->get();
        
    //     // Fetch all categories for filtering dropdown
    //     $categories = Category::all();
        
    //     return view('frontend.user.customer.catalog', compact('products', 'categories'))
    ...
    public function catalog(Request $request)
{
    ...
    // Base Query
    $products = Product::with('stocks'); // Ensuring stock data is loaded
