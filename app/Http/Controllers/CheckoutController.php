...
//        if (Session::has('cart') && count(Session::get('cart')) > 0) {
        ...
        $carts_del_info = Cart::where('user_id', Auth::user()->id)
                ->get();
        //echo '<pre>';print_r($carts_del_info);die;
        ...
        if ($carts_del_info && count($carts_del_info) > 0) {
            ...
            return view('frontend.shipping_info', compact('categories','customerlist','carts','carts_del_info','shipping_info', 'total'));
